...
//        // stesso di mitra -- Effect plas22 = new Effect (1,0,1,1,false,false,0,0,1,2,0,12,false,true,false,2,false,false, Target.PLAYER);
        ...
        Effect plas21 = new MovementEffect(0,0,0,0,1,2,TargetVisibility.VISIBLE,true,TargetVisibility.EVERYWHERE,false,false,false,false,true);
...
//        Effect ray11 = new Effect (3,0,1,1,true,false,-1,-1,2,1,0,2,false,false,false,0,false,false,Target.PLAYER)
        Effect ray01 = new MovementEffect(1,1,0,Map.MAX_DIST,0,2,TargetVisibility.EVERYWHERE,false,TargetVisibility.VISIBLE,false,false,false,false,false);
        ...
        Effect ray11 = new MovementEffect(1,1,0,2,0,2,TargetVisibility.EVERYWHERE,false,TargetVisibility.VISIBLE,true,false,false,false,false);
...
//        Effect vort21 = new Effect (1,0,1,2,true,false,0,1,1,2,0,1,false,false,true,2,false,false,Target.PLAYER);
        ...
        //TODO L'ultimo dev'essere fatto se e solo se è stato fatto il penultimo (ma forse se lastTarget è vuoto si evita il problema)
...
//        //effetto cyb14 solo se fatto cyb13 (CORRETTO)
        ...
        Effect cyb11 = new MovementEffect(1,1,1,1,TargetVisibility.VISIBLE,true,TargetVisibility.EVERYWHERE,false,false,false,false,false);
        Effect cyb12 = new PlainDamageEffect(0,1,0,,0,TargetVisibility.VISIBLE,2,0,false,DifferentTarget.ANYONE,false,false);

        Effect cyb13 = new MovementEffect(0,1,1,1,TargetVisibility.VISIBLE,true,TargetVisibility.EVERYWHERE,false,false,false,true,false);
        Effect cyb14 = new PlainDamageEffect(0,1,0,0,TargetVisibility.VISIBLE,2,0,false,DifferentTarget.ANYONE,false,false);
...
//        Effect ond01 = new Effect (1,0,1,3,false,false,0,0,1,2,1,1,false,false,false,0,false,false,Target.PLAYER);
        ...
        Effect sled12 = new MovementEffect(1,1,0,1,TargetVisibility.VISIBLE,false,TargetVisibility.EVERYWHERE,false,false,true,false,false);
        Effect sled13 = new MovementEffect(1,1,0,1,TargetVisibility.VISIBLE,false,TargetVisibility.EVERYWHERE,false,false,true,true,false);
        ...
        //Newton
        Effect nw01 = new MovementEffect(1,1,0,Map.MAX_DIST,TargetVisibility.EVERYWHERE,false,TargetVisibility.EVERYWHERE,false,false,false,false,false);
        Effect nw02 = new MovementEffect(0,1,0,Map.MAX_DIST,TargetVisibility.EVERYWHERE,false,TargetVisibility.EVERYWHERE,false,false,true,true,false);

        //Telereporter
        Effect tr01 = new MovementEffect(0,0,0,0,TargetVisibility.VISIBLE,true,TargetVisibility.EVERYWHERE,false,false,false,false,false);
